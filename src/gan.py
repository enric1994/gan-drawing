...
# Load to numpy array (121383, 784)
data = np.load("/gan-drawing/dataset/raw/monalisa.npy")
...
# Reshape 784 array to 28x28 matrix
# mat=np.reshape(data[0],(-1,28))

# Save image
# scipy.misc.imsave('outfile.jpg', mat)
...
checkpoint_dir = '/gan-drawing/training_checkpoints'
